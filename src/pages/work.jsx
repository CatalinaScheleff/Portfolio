      ...
      <WorkCon id="WorkCon">
        <WorkTitleCon id="WorkTitleCon">
          ...
          {isMenuOpen && (
            <CaretDownMenuCon id="CaretDownMenuCon" isOpen={isMenuOpen}>
              <MenuA
                href="#InspirationalQuoteGenerator"
        ...
        <WorkContentCon id="WorkContentCon">
          <WorkContent id="InspirationalQuoteGenerator">
            ...
            <ContentTextCon>
              <p>
                Personal project to generate and download images with
                inspirational quotes
              </p>
              <p>
                With the help of FreeCodeCamp, I was able to create a random
                quote generator using the ZenQuotes API.
              </p>
              <p>This website was deployed using AWS.</p>
              <p>
                HTML/CSS - Styled-components - React.js - REST API - AWS -
          ...
          <WorkContent id="AppleGeeks">
            ...
            <ContentTextCon>
              <p>
                Online platform dedicated exclusively to the publication and
                promotion of services related to the range of Apple products.
              </p>
              <p>
                HTML/CSS - Javascript - React.js - Bootstrap - Python - Flask -
                REST API - JWT
              </p>
              <br />
              <p>Github: </p>
              <ContentLink
                to={"https://github.com/CatalinaScheleff/Apple-Geeks"}
                target="_blank"
                rel="noreferrer"
              >
          ...
          <WorkContent id="RickAndMortyBlog">
            ...
            <ContentTextCon>
              <p>
                A web application involving the reading and visualization of
                data related to the &apos;Rick and Morty&apos; series.
              </p>
