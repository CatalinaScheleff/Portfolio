import { CertificationCon, CertificationContent, CertificationContentCon, CertificationH1, CertificationImg, CertificationTitle, CertificationTitleCon } from "../components/certification/CertificationElements";
      ...
      <CertificationCon id="CertificationCon">
        ...
        <CertificationContentCon id="CertificationContentCon">
          <CertificationContent>
            ...
            <CertificationH1>Full Stack Developer - 4Geeks Academy</CertificationH1>
            </CertificationContent>
